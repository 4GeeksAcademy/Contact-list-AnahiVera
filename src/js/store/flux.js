    ...
    return {
        ...
        actions: {
            ...
            getContactList: () => {
                ...
                fetch(`${baseUrl}/contact/agendas/AnahiVera`)
                    .then((response) => {
                        if (!response.ok) {
            ...
            addContact: (newContact) => {
                ...
                fetch(`${baseUrl}/contact/agendas/AnahiVera/contacts`, options)
                    .then((response) => {
                        if (!response.ok) {
            ...
            updateContact: (contact, id) => {
                ...
                const { baseUrl, contactsList } = getStore()
                fetch(`${baseUrl}/contact/agendas/AnahiVera/contacts/${id}`, options)
                    .then((response) => {
                        if (!response.ok) {
